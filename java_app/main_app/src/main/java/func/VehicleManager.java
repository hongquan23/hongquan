...
public class VehicleManager {
    ...
    // Phương thức thống kê tổng số lượng xe theo hình thức thi
    public Map<String, Integer> statisticVehiclesByExamType() {
        Map<String, Integer> examTypeCounts = new HashMap<>();
        for (Vehicle vehicle : vehicles) {
            String examType = vehicle.getExamAssigned();
            examTypeCounts.put(examType, examTypeCounts.getOrDefault(examType, 0) + 1);
        }
        return examTypeCounts;
    }
